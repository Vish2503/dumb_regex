...
int RegularExpression::parser_match(char c) {
    if (parser_peek() != c) {
...
int RegularExpression::parser_match_one_of(string s) {
...
int RegularExpression::parser_match_none_of(string s) {
...
pair<int, int> RegularExpression::parse_RE() {
...
pair<int, int> RegularExpression::parse_REtail(pair<int, int> lvalue) {
    if (parser_peek() == '|') { 
        parser_match('|');
...
pair<int, int> RegularExpression::parse_simple_RE() {
...
pair<int, int> RegularExpression::parse_simple_REtail(pair<int, int> lvalue) {
    pair<int, int> basic_RE_res = parse_basic_RE();
...
pair<int, int> RegularExpression::parse_basic_RE() {
...
pair<int, int> RegularExpression::parse_elementary_RE() {
...
pair<int, int> RegularExpression::parse_group() {
    if (parser_peek() == '(') {
        parser_match('(');
...
pair<int, int> RegularExpression::parse_any() {
    if (parser_peek() == '.') {
        parser_match('.');
...
pair<int, int> RegularExpression::parse_char() {
...
pair<int, int> RegularExpression::parse_set() {
    if (parser_peek() == '[') {
        parser_match('[');
...
pair<int, int> RegularExpression::parse_set_items() {
...
pair<int, int> RegularExpression::parse_set_item() {
...
pair<int, int> RegularExpression::parse_range(pair<int, int> lvalue) {
    if (parser_peek() == '-') {
        parser_match('-');
...
pair<int, int> RegularExpression::parse_set_char() {
    const string meta_characters = "[]\\"; // special characters which already have a special meaning before escaping
...
pair<int, int> RegularExpression::make_deep_copy(int start, int end) {
...
void RegularExpression::epsilon_closure(int curr, set<int>& res) {
    res.insert(curr);
...
void RegularExpression::generate_epsilon_nfa() {
...
void RegularExpression::generate_nfa() {
    if (engine_state >= NFA)
        return;
...
void RegularExpression::generate_dfa() {
    if (engine_state >= DFA)
        return;
...
void RegularExpression::generate_minimized_dfa() {
...
bool RegularExpression::match_epsilon_nfa(string input) {
...
bool RegularExpression::match_nfa(string input) {
...
bool RegularExpression::match_dfa(string input) {
...
bool RegularExpression::match_minimized_dfa(string input) {
...
RegularExpression::RegularExpression(string p) : pattern(p) {
    generate_minimized_dfa();
}

bool RegularExpression::match(string input) {
    switch (engine_state) {
        case EPSILON_NFA:
...
void RegularExpression::generate_graphviz_files() {
